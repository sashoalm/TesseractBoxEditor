...
void MainWindow::createActions()
{
    ...
    importTextSymAct = new QAction(tr("Import &text file"), this);
    ...
    DirectTypingAct = new QAction(tr("&Direct type mode"), this);
    ...
    drawRectAct = new QAction(tr("Draw/Hide &Rectangle…"), this);
